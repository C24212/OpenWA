...
- The dashboard Message Tester's Bulk mode can attach a file or a media URL, sent as image, video, audio or document with the message text as the caption. An inline file too large to repeat for every recipient is refused before sending. Thanks @C24212.
