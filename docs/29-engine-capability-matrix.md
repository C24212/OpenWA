...
(🔧⁷ wwjs), `setGroupDescription` (🔧⁹ wwjs), and every media-carrying send (🔧¹⁰ wwjs). Everything else that is ✅-both carries no row-level mark, but still
